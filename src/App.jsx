                                ...
                                {session ? (
                                    <>
                                        <button
                                            ...
                                            className=" min-w-[100px] cursor-pointer items-center justify-center rounded-lg h-9 px-4 bg-primary hover:bg-blue-600 text-white text-sm font-bold transition-all shadow-lg active:scale-95 z-20"
                                        >
