            ...
            <div className="w-full max-w-[420px] flex flex-col gap-6 animate-in fade-in zoom-in duration-300">
                ...
                <div className="bg-[#1c1c27] rounded-xl border border-[#282839] shadow-xl p-6 sm:p-8">
                    ...
                    <form onSubmit={handleAuth} className="flex flex-col gap-5">
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    {!isSignUp && (
                                        <button
                                            ...
                                            className="text-xs font-medium text-primary hover:text-blue-400 transition-colors cursor-pointer"
                                        >
                                            Forgot Password?
                                        </button>
                                    )}
                        ...
                        <button
                            type="button"
                            onClick={isForgotPassword ? () => toggleMode('login') : onCancel}
                        ...
                        >
                            {isForgotPassword ? 'Back to Login' : 'Return to Home'}
                        </button>
                    </form>
