        ...
        <div className="flex flex-1 items-center justify-center p-6 z-10 w-full">
            <div className="w-full max-w-[420px] flex flex-col gap-6 animate-in fade-in zoom-in duration-300">
                <div className="flex flex-col items-center gap-4 mb-2">
                    <div className="size-12 flex items-center justify-center bg-primary rounded-xl text-white shadow-lg shadow-blue-900/20">
                        <span className="material-symbols-outlined text-[28px]">flag</span>
                    </div>
                    <div className="text-center">
                        <h1 className="text-white text-2xl font-bold leading-tight tracking-[-0.015em]">Race Bulletin</h1>
